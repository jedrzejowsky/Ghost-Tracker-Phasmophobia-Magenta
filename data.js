...
const GHOSTS = [
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Цель:</strong> Выбирает одного игрока ('Одержимость'). Игнорирует других во время охоты, если цель в доме.</li><li><strong>Порог охоты:</strong> Учитывает рассудок <strong>ТОЛЬКО Цели</strong> (>50%). Средний рассудок не важен.</li><li><strong>Способность:</strong> Часто бродит прямо к местоположению своей цели.</li><li><strong>Уникально:</strong> Имеет 33% шанс издать уникальный крик в направленный микрофон.</li><li><strong>Имя:</strong> Не может иметь <strong>мужского имени</strong> (всегда женское).</li></ul>`
        }
    },
    {
        name: "Demon",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Проклятие:</strong> Ответ в Радио или шепот в микрофон проклинает (теряете рассудок в 2 раза быстрее). Лечится таблетками.</li><li><strong>Скорость:</strong> Обратно пропорциональна рассудку. 1.5 м/с (высокий рассудок) -> <strong>2.25 м/с</strong> (0%).</li><li><strong>Слепота:</strong> Благовоние ослепляет его на <strong>12 секунд</strong> во время охоты (обычно 6с).</li></ul>`
        }
    },
    {
        name: "Myling",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Отпечатки:</strong> 16.7% шанс оставить <strong>отпечаток с 6 пальцами</strong>. 25% шанс НЕ оставить отпечаток вообще.</li><li><strong>Оборотень:</strong> Во время охоты может (6.66%) сменить модель на другую при мерцании.</li><li><strong>Способность:</strong> Может сократить время жизни отпечатков вдвое.</li></ul>`
        }
    },
    {
        name: "Oni",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Рассудок:</strong> Взгляд на Фантома снижает рассудок на 0.5% в секунду.</li><li><strong>Фото:</strong> Фото заставляет его <strong>исчезнуть мгновенно</strong>. Фото чистое, без помех.</li><li><strong>Мигание:</strong> На охоте невидим очень долго (1-2с). Трудно отслеживать визуально.</li></ul>`
        }
    },
    {
        name: "Poltergeist",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Усиление от тока:</strong> Охотится при <strong>65% рассудка</strong> и бегает <strong>2.5 м/с</strong>, если рядом активная электроника.</li><li><strong>Помехи:</strong> Глючит электронику с <strong>15 метров</strong> (обычно 10м).</li><li><strong>Стратегия:</strong> Выключайте фонарик и оборудование, когда прячетесь!</li></ul>`
        }
    },
    {
        name: "Revenant",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Старение:</strong> Стареет каждые 1-2 минуты, если игрок рядом.</li><li><strong>Молодой:</strong> 2.75 м/с, охота с 75%. Очень опасен в начале.</li><li><strong>Старый:</strong> 1.0 м/с, охота с 15%. Медленный.</li><li><strong>Нет ускорения:</strong> НЕ ускоряется, увидев вас.</li></ul>`
        }
    },
    {
        name: "The Twins",
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Приманка:</strong> Взаимодействия могут происходить через 'Приманку' далеко от самого призрака.</li><li><strong>Охота:</strong> 50% шанс охоты от Главного (1.5 м/с) или Приманки (1.9 м/с).</li><li><strong>Улики:</strong> Только Главный дает все улики. Приманка дает ЭМП, но НЕ дает Радио.</li></ul>`
        }
    },
    {
        name: "Wraith",
    ...
    },
    {
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Дверь:</strong> Может с размаха закрыть дверь, сняв <strong>12.5% рассудка</strong> игрокам в комнате.</li><li><strong>Слабость:</strong> Благовоние запирает его в комнате на 90 секунд.</li><li><strong>Вход:</strong> Единственный призрак, трогающий входную дверь.</li></ul>`
        }
    },
    {
        name: "Dayan",
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Механика:</strong> Чувствует движение игроков.</li><li><strong>Скорость:</strong> Медленный (1.2 м/с), если СТОИТЕ. Быстрый (2.25 м/с), если ДВИГАЕТЕСЬ.</li><li><strong>Охота:</strong> 45% (стоя) или 60% (двигаясь).</li><li><strong>Стратегия:</strong> Стойте смирно, чтобы замедлить его. Без паники.</li><li><strong>Имя:</strong> Всегда женское.</li></ul>`
        }
    },
    {
        name: "Gallu",
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Ярость:</strong> Использование Благовония, Распятия или Соли ЗЛИТ его.</li><li><strong>Статы:</strong> В ярости: 2.0 м/с, охота с 60%. Ослаблен: 1.36 м/с, охота с 40%.</li><li><strong>Соль:</strong> В ярости НЕ наступает в соль (парит).</li><li><strong>Тест:</strong> Если ускоряется ПОСЛЕ благовония, это Галлу.</li></ul>`
        }
    },
    {
        name: "Obambo",
        ...
        longDesc: {
            ...
            ru: `<ul><li><strong>Цикл:</strong> Меняет режим каждые ~2 минуты.</li><li><strong>Агрессивный:</strong> Быстрый (1.96 м/с), охота с 65%, активный.</li><li><strong>Спокойный:</strong> Медленный (1.45 м/с), охота с 10% (как Тень).</li><li><strong>Время:</strong> Имеет <strong>самую короткую охоту</strong> в игре.</li><li><strong>Стратегия:</strong> Если дух меняется с буйного на сонного, это Обамбо.</li></ul>`
        }
    }
];
